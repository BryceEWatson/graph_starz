...
## Data Structure
- **Users**: Platform users who can upload and interact with images.
- **Images**: User-uploaded images with metadata and AI-identified attributes.
...
- **Image**: `id`, `title`, `description`, `url`, `width`, `height`, `createdAt`
- **Attribute**: `id`, `type`, `value`, `confidence`
